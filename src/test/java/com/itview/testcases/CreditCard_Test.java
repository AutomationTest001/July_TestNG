...
import com.itview.pagobject.CreditCard_PageObj;
...
@Listeners(com.itview.pagobject.Listeners.class)
...
public class CreditCard_Test {
	...
	public void outStandingAmount_10000() throws Throwable {	
	    ...
	    Assert.assertEquals(cc.getValidationValue(cc.totalPaymentCalculated), "15,730");//15,730.99
